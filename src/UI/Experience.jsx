			...
			{experiencies.map((experience) => (
				<article
					...
					<div class="text-left flex flex-col">
						<h1 class="text-xl font-semibold text-orange-800 mb-2">
							{experience.title}
						</h1>
						<h2 class="text-lg font-medium text-orange-900">
							{experience.company}
						</h2>
						{language === "es" ? (
							...
							<a
								...
								{language === "es" ? (
									<button onClick={() => onClick(experience.id)}>
										<p class="text-sm text-[#696965]">Ver más</p>
									</button>
								) : (
									<button onClick={() => onClick(experience.id)}>
										<p class="text-sm text-[#696965]">See more</p>
									</button>
								)}
							</a>
						</div>
